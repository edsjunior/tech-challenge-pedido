        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeaderPedidoId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemPedidos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemPedidos_PedidoHeaders_HeaderPedidoId",
                        column: x => x.HeaderPedidoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemPedidos_HeaderPedidoId",
                table: "ItemPedidos",
                column: "HeaderPedidoId");
